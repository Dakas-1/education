...
<body>
<br>
<a href = "/lesson14/public/index.php/?ctrl=Index">На главную</a>;
<?php
if (isset($this)) {
    foreach ($this->article as $key => $article) {
        echo '<h3><a href="http://php1.local/lesson14/public/index.php/?ctrl=Admin&id=' . $article->id . '">' . $article->title . '</a></h3>';
